	...
	array( "name" => "wrap-general",
		...
		array( "name" => "general-2",
			...
			array( "name" => esc_html__("Quote Text",$themename),
                   ...
                   "std" => 'This is where you can place an amazing quote about your business. We provide the best services anywhere.',
                   "type" => "text",
			...
			array( "name" => esc_html__("Recent Work Section Category",$themename),
				   "id" => $shortname."_home_recentwork_category",
				   "std" => "",
				   "type" => "select",
				   "desc" => esc_html__("desc.",$themename),
				   "options" => $site_cats),
			...
			array( "name" => esc_html__("Number of Posts in 'Recent Work' Section",$themename),
                   "id" => $shortname."_recentwork_posts_num",
                   "std" => "8",
                   "type" => "text",
			...
			array( "name" => esc_html__("From The Blog Section Category",$themename),
				   "id" => $shortname."_home_recentblog_category",
				   "std" => "",
				   "type" => "select",
				   "desc" => esc_html__("desc.",$themename),
				   "options" => $site_cats),
			
			array( "name" => esc_html__("Number of Posts in 'From The Blog' Section",$themename),
                   "id" => $shortname."_from_blog_posts_num",
                   "std" => "3",
                   "type" => "text",
				   "desc" => esc_html__("Here you can designate how many recent articles are displayed in From The Blog section on the homepage. ",$themename)
			),
...
//-------------------------------------------------------------------------------------//
	...
	array( "name" => "wrap-layout",
		...
		array( "name" => "layout-1",
			...
			array( "name" => esc_html__("Show Date Icon",$themename),
				   "id" => $shortname."_show_date_icon_single",
				   "type" => "checkbox",
				   "std" => "on",
				   "desc" => esc_html__("desc.",$themename)
			),
		...
		array( "name" => "layout-3",
			...
			array( "name" => esc_html__("Show Date Icon",$themename),
				   "id" => $shortname."_show_date_icon_index",
				   "type" => "checkbox2",
				   "std" => "on",
				   "desc" => esc_html__("desc.",$themename)
			),
