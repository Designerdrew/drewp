		...
		<div id="et_pt_blog" class="responsive">
			...
			<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
				...
				<div class="et_pt_blogentry clearfix">
					...
					<p class="et_pt_blogmeta"><?php esc_html_e('Posted','Trim'); ?> <?php esc_html_e('by','Trim'); ?> <?php the_author_posts_link(); ?> <?php esc_html_e('on','Trim'); ?> <?php the_time(get_option('evolution_date_format')) ?> <?php esc_html_e('in','Trim'); ?> <?php the_category(', ') ?> | <?php comments_popup_link(esc_html__('0 comments','Trim'), esc_html__('1 comment','Trim'), '% '.esc_html__('comments','Trim')); ?></p>
